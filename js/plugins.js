...
!(function (t, e, i) {
  ...
  (o = function (i) {
    var o = "webuiPopover",
      ...
      v =
        "ontouchstart" in e.documentElement && /Mobi/.test(navigator.userAgent),
      y = function (t) {
        var e = { x: 0, y: 0 };
        if (
          "touchstart" === t.type ||
    ...
    (w.prototype = {
      init: function () {
        if (this.$element[0] instanceof e.constructor && !this.options.selector)
          throw new Error(
        ...
        "manual" !== this.getTrigger() &&
          (v
            ...
            ? this.$element
                ...
                .on("click", this.options.selector, i.proxy(this.toggle, this))
      ...
      displayContent: function () {
        ...
        "" === u && (u = this._defaults.height),
          ...
          this.options.padding ||
            ("auto" !== this.options.height && h.css("height", h.outerHeight()),
        ...
        if (
          ...
          w.removeAttr("style"),
            ...
            g.arrowOffset &&
              (-1 === g.arrowOffset.left || -1 === g.arrowOffset.top
                ? w.hide()
                : w.css(g.arrowOffset));
        }
      ...
      getOffsetTop: function () {
        return (
          u(this.$element.attr("data-offset-top")) || this.options.offsetTop
        );
      },
      getOffsetLeft: function () {
        return (
          u(this.$element.attr("data-offset-left")) || this.options.offsetLeft
        );
      },
      getCache: function () {
          ...
          (this.options.dismissible && "click" === this.getTrigger()
            ? v
              ...
              : (d
                  ...
                  .on("keyup.webui-popover", i.proxy(this.escapeHandler, this)),
                d
      ...
      getPlacement: function (t) {
        ...
        return (
          "auto" === e || l || c
            ...
            : "auto-top" === e
            ? (e =
                r < o / 3 ? "top-right" : r < (2 * o) / 3 ? "top" : "top-left")
            : "auto-bottom" === e
            ? (e =
                r < o / 3
                  ? "bottom-right"
      ...
      getTargetPositin: function (t, i, o, n) {
        ...
        switch (i) {
          ...
          case "top-left":
            (v = $ ? g : -10),
              (p = { top: s.top - n, left: s.left - o + s.width + v }),
              (d = { left: $ ? o - Math.min(r, o) / 2 - g : f });
            break;
          case "bottom-right":
            (p = { top: s.top + s.height, left: b ? s.left - g : 10 }),
              (d = { left: b ? Math.min(r, o) / 2 + g : f });
            break;
          case "bottom-left":
            (v = $ ? g : -10),
              (p = { top: s.top + s.height, left: s.left - o + s.width + v }),
              (d = { left: $ ? o - Math.min(r, o) / 2 - g : f });
            break;
          case "right-top":
            (v = C ? m : -10),
              (p = { top: s.top - n + s.height + v, left: s.left + s.width }),
              (d = { top: C ? n - Math.min(a, n) / 2 - m : f });
            break;
          case "right-bottom":
            (p = { top: T ? s.top - m : 10, left: s.left + s.width }),
              (d = { top: T ? Math.min(a, n) / 2 + m : f });
            break;
          case "left-top":
            (v = C ? m : -10),
              (p = { top: s.top - n + s.height + v, left: s.left - o }),
              (d = { top: C ? n - Math.min(a, n) / 2 - m : f });
            break;
          case "left-bottom":
          ...
          s = this.each(function () {
            ...
            s
              ...
              : (t
                  ? "string" == typeof t
                    ? "destroy" !== t &&
                      (e || ((s = new w(this, null)), n.push(s[t]())))
                    : "object" == typeof t && (s = new w(this, t))
                  : (s = new w(this, null)),
      ...
      updateContentAsync: function (t, e) {
        ...
        if (n) {
          ...
          (n.options.cache = !1),
            ...
            n._opened
              ? ((n._opened = !1), n.show())
              : ((n.options.type = "async"), n.setContentASync(n.content)),
            (n.options.cache = s),
            (n.options.type = h);
        }
      },
