...
const createEventTeamSection = (eventName, imagesOfCordinators) => {
  imagesOfCordinators = imagesOfCordinators.sort((a, b) => {
...
<div class="col-lg-9 mt-4 mt-lg-0">
  ...
  for (let el of imagesOfCordinators) {
    try {
      EventTeamCardLayout += `<img src="${imgBaseUrl}/${el.image}" alt="">`;
    } catch {
      console.log(el.name, "image not found");
    }
  }
